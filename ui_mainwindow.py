...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionHilfsdokument_anzeigen = QAction(MainWindow)
        self.actionHilfsdokument_anzeigen.setObjectName(u"actionHilfsdokument_anzeigen")
        self.action_ber_Realtime_Latency_Visualiser = QAction(MainWindow)
        self.action_ber_Realtime_Latency_Visualiser.setObjectName(u"action_ber_Realtime_Latency_Visualiser")
        icon1 = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.DialogInformation))
        self.action_ber_Realtime_Latency_Visualiser.setIcon(icon1)
        ...
        self.menuHilfe.addAction(self.actionHilfsdokument_anzeigen)
        self.menuHilfe.addAction(self.action_ber_Realtime_Latency_Visualiser)
...
#endif // QT_CONFIG(shortcut)
        self.actionHilfsdokument_anzeigen.setText(QCoreApplication.translate("MainWindow", u"Hilfsdokument anzeigen", None))
#if QT_CONFIG(shortcut)
        self.actionHilfsdokument_anzeigen.setShortcut(QCoreApplication.translate("MainWindow", u"F1", None))
#endif // QT_CONFIG(shortcut)
        self.action_ber_Realtime_Latency_Visualiser.setText(QCoreApplication.translate("MainWindow", u"\u00dcber Realtime Latency Visualiser", None))
